    ...
    <div className={`grid grid-cols-2 gap-4 ${className}`}>
      ...
      <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-sm">
        <div className="flex items-center mb-2">
          ...
          <p className="text-sm font-semibold text-[#262626]">Shipping:</p>
        </div>
        <div className="ml-10">
      ...
      <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-sm">
        <div className="flex items-center mb-2">
          ...
          <p className="text-sm font-semibold text-[#262626]">Estimated delivery:</p>
        </div>
        <div className="ml-10">
      ...
      <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-sm">
        <div className="flex items-center mb-2">
          ...
          <p className="text-sm font-semibold text-[#262626]">Returns:</p>
        </div>
        <div className="ml-10">
