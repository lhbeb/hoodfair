    ...
    <div className="min-h-screen flex flex-col bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="prose max-w-none text-gray-600">
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Free Shipping</h2>
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Shipping Times</h2>
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Order Tracking</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Shipping Restrictions</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Package Protection</h2>
          <p className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#262626] mt-8 mb-4">Contact Information</h2>
          <p>
          ...
          <div className="bg-blue-50 p-6 rounded-lg mt-8">
            <h3 className="text-lg font-bold text-[#262626] mb-2">Important Note</h3>
            <p className="text-sm">
