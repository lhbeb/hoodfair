  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold text-[#262626] mb-8">Return Policy</h1>
        ...
        <div className="prose max-w-none text-gray-700 space-y-8">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">30 Day Satisfaction Guarantee</h2>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">How to Start a Return</h2>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">Inspection and Processing Time</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">Return Shipping Costs</h2>
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">Items Not Eligible for Return</h2>
            <p className="mb-4">
          ...
          {/* We Are Here to Help */}
          <div>
            <h2 className="text-3xl font-bold text-[#262626] mt-10 mb-4">We Are Here to Help</h2>
            <p className="mb-4">
