        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://ko-fi.com https://*.ko-fi.com https://vfuedgrheyncotoxseos.supabase.co https://www.google-analytics.com https://api.stripe.com https://*.stripe.com https://hooks.stripe.com https://*.stripe.network https://chatapppay.vercel.app https://*.tidio.co https://analyticsapp-five.vercel.app",
              "object-src 'none'",
              "base-uri 'self'",
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://ko-fi.com https://*.ko-fi.com https://vfuedgrheyncotoxseos.supabase.co https://api.stripe.com https://*.stripe.com https://hooks.stripe.com https://*.stripe.network https://chatapppay.vercel.app https://*.tidio.co https://analyticsapp-five.vercel.app",
              "object-src 'none'",
              "form-action 'self' https://ko-fi.com https://*.ko-fi.com",
            ].join('; '),
          },
